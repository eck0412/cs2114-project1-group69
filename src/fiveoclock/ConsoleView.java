...
public class ConsoleView { 
    ...
    /**
     * @param scanner reads the user's input; must not be null
     * @param output displays text to the users; must not be null
     ...
     * @param localTime the locations local time and date
     * @throws IllegalArgument Exception if either argument is null
     */
    public void showLocation(Location location, ZonedDateTime localTime) {
        ...
        output.println();
        output.println("It's five o'clock in "
     ...
     * a blank message produces a general error instead 
     */
    ...
    public void showNoMatch() {
        output.println();
        output.println("No saved location is in the 5 o'clock hour "
